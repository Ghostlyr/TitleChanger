...
@Mod(modid = TitleChanger.MODID, useMetadata = true, acceptedMinecraftVersions = "[1.10,1.12]", updateJSON = "https://raw.githubusercontent.com/Maxwell-lt/TitleChanger/master/update.json")
